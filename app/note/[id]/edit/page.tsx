...
export default function EditNotePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-pink-50 to-rose-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      {/* Header */}
      ...
      <main className="px-4 py-6">
        <div className="max-w-md mx-auto space-y-6">
          {/* Image Upload */}
          <div className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm rounded-2xl p-4 shadow-lg border border-white/20">
            {image ? (
